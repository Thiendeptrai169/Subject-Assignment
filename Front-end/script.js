...
console.log('Script chạy, DOM ready check:', document.readyState);
...
// Định tuyến "Quản lý nhóm" tùy theo vai trò
document.addEventListener("DOMContentLoaded", () => {
    const role = localStorage.getItem("role"); // ví dụ lưu role trong localStorage
    const link = document.getElementById("group-management-link");
    if (role === "1") {
        link.href = "/lecturer-project.html";
    } else if (role === "2") {
        link.href = "/group-page.html";
    }
});
